                ...
                <div class="add-visitor">
                    <div class="row">
                        ...
                        <div class="col-xl-6 ">
                            ...
                            <div class="col-md-6">
                                <div class="primary_input mb-25">
                                    <label class="primary_input_label" for="">{{ __('seller.vendor_id') }} <span class="text-danger">*</span></label>
                                    <input type="text" class="primary_input_field" placeholder="{{ __('seller.vendor_id') }}" name="vendor_id" value="{{ old('vendor_id')? old('vendor_id'):$seller->sellerAccount->vendor_id }}">
                        ...
                        <div id="holiday_end_date_div"
                            ...
                            <div class="col-lg-12 text-left " data-title="" data-original-title="" title="">
                                <a href="{{route('seller.stripe.connect')}}" class="primary-btn fix-gr-bg tooltip-wrapper " id="sellerAccountBtn">
                                    <span class="ti-credit-card"></span>
                                @if(auth()->user()->stripe_account_id)
                                    Stripe Connected ({{auth()->user()->stripe_account_id}})
                                    @else
                                        Connect with Stripe
                                    @endif
