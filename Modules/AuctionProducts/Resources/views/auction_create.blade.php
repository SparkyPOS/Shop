                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input mb-25">
                                                ...
                                                <input class="primary_input_field" type="text" id="quantity" name="quantity" min='0' pattern="[0-9]*" autocomplete="off" value="{{ old('quantity')??1 }}" placeholder="{{__('auctionproduct.quantity')}}">
                                                @error('quantity')
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input mb-25">
                                                ...
                                                <input class="primary_input_field" type="number" step="0.01" min='0' max='100' id="percentage" name="percentage" autocomplete="off" value="{{ old('percentage', 0) }}" placeholder="e.g. 5">
                                                @error('percentage')
