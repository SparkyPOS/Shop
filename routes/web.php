...
Route::get('/shop',[CategoryController::class,'shop'])->name('frontend.shop');
...
Route::get('/seller-profile/{seller_id}/{vendor_id?}',[SellerController::class,'index'])->name('frontend.seller');
