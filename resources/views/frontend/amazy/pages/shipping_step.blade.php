                                ...
                                @endif
                                    ...
                                    <div class="col-12">
                                        <div class="check_v3_btns flex-wrap d-flex align-items-center">
                                            @if(isModuleActive('INTShipping'))
                                              <button {{ in_array(0,$can_process) ? 'disabled':'' }} type="submit" class="amaz_primary_btn style2 {{ in_array(0,$can_process) ? 'disabled':'' }} min_200 text-center text-uppercase" id="IntshippingBtn">{{__('defaultTheme.continue_to_payment')}}</button>
                                            @else
