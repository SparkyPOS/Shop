...
{
    use HasFactory, Notifiable, HasApiTokens,SendMail,HasSlug;
    ...
    public function getSlugOptions(): SlugOptions
    {
        return SlugOptions::create()
            ->generateSlugsFrom(function () {
                return $this->SellerAccount()->exists()
                    ? implode('-', $this->SellerAccount()->pluck('seller_shop_display_name')->toArray())
                    : $this->name;
            })
            ->saveSlugsTo('slug');
    }
